...
{
    /// <summary>
    ///  class List (of strings, with index), made of ListsElements (inner class).
    /// </summary>
    public class List
    {
        /// <summary>
        ...
        /// <summary>
        /// This property return the size of the list.
        /// </summary>
        public int Size => size;

        protected ListElement FindPrevious(int index)
        {
            int i = 1;
